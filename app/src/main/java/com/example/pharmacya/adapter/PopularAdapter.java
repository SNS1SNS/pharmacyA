...
import com.example.pharmacya.activity.ViewAllActivity;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.ViewHolder>
{
    ...
    public PopularAdapter(Context context, List<PopularModel> popularModelpList) {
        this.context = context;
        this.popularModelList = popularModelpList;
    }
    @NonNull
    @Override
